  ...
  return (
    <>
        ...
        <header className="portfolio-header">
          ...
          <Grid item xs={12} md={4} className="portfolio-item width-2x" sx={{ cursor: "pointer" }} onClick={toggleModalTwo} >
          <div className="portfolio-meta">
<time>EVENTS</time>
</div>
<header className="portfolio-header">
...
<Grid item xs={12} md={3} className="portfolio-item dark" sx={{ cursor: "pointer" }} onClick={toggleModalThree}>
<div className="portfolio-meta">
...
<Grid item xs={12} md={3} className="portfolio-item dark" sx={{ cursor: "pointer" }} onClick={toggleModalFour}>
<div className="portfolio-meta">
...
<Grid item xs={12} md={3} className="portfolio-item" sx={{ cursor: "pointer" }} onClick={toggleModalFive} >
<div className="portfolio-meta">
<time>PODCAST</time>
</div>
<header className="portfolio-header">
...
<Grid item xs={12} md={3} className="portfolio-item dark" sx={{ cursor: "pointer" }} onClick={toggleModalSix} >
<div className="portfolio-meta">
...
<Grid item xs={12} md={4} className="portfolio-item width-2x dark" sx={{ cursor: "pointer" }} onClick={toggleModalSeven} >
<div className="portfolio-meta">
<time>EVENTS</time>
</div>
<header className="portfolio-header">
...
<Grid item xs={12} md={4} className="portfolio-item width-2x dark" sx={{ cursor: "pointer" }} onClick={toggleModalEight}  >
<div className="portfolio-meta">
