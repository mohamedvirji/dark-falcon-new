...
// Images
// import bgImage from "assets/images/headers/ProductHeader.png";

function Product() {
  ReactGA.send({ hitType: "pageview", page: "/product", title: "Product Videos" });
  const videoSource = "https://d2u61031vokrmr.cloudfront.net/webp/videos/Product.mp4";
  return (
    <>
      <DefaultNavbar
        routes={routes}
