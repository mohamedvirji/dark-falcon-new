...
export default [
  {
    ...
    items: [
      {
        image: `${imagesPrefix}/dfp-thumbnails_3++Adidas+Dragonball+Z+Limited+Edition--01.webp`,
      ...
      {
        image: `${imagesPrefix}/dfp-thumbnails_4+-++Synergy+Medical+Pill+Dispenser+Machine-01.webp`,
      ...
      {
        image: `${imagesPrefix}/dfp-thumbnails_VT+-+1+-++Barclays+Uniform+Season+2021-01.webp`,
        name: "Barclays",
      ...
      {
        image: `${imagesPrefix}/dfp-thumbnails_2+-+Ertugrul+Kayi+Musical+Box+and+Key+Ring-01.webp`,
        name: "Ertugrul",
