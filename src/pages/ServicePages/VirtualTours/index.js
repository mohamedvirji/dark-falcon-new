...
import DesignBlocks from "pages/ServicePages/VirtualTours/sections/DesignBlocks";
...
// Images
import bgImage from "assets/images/headers/VirtualToursHeader.png";

function VirtualTours() {
  ReactGA.send({ hitType: "pageview", page: "/virtual-tours", title: "Virtual Tours Videos" });
  return (
    <>
        <DefaultNavbar
          routes={routes}
